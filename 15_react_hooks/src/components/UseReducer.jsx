...
const reducer = (prevState, action) => {
  ...
  //reducer 함수 내부에는 조건문을 많이 사용함ㅂ
  //switch나 if else 등등
  //왜 조건문을 사용?-> 복잡한 state를 관리한다는 것은 state가 한 가지만 있는 것이 아니고,
...
export default function UseReducer() {
  ...
  //디스패치는 인자로 원래 action을 가지고 있음
  //디스패치는 state를 바꿔주는 것이 아니라 state 업데이트 하기 위한 요구(action)을 담아다가 reducer로 전달함
  return (
    <>
      <h2>useReducer 사용</h2>
      <div>잔고{money}원</div>
